...
void main() {
  ...
  testWidgets('VehicleDropDown handles selection and images without errors', (tester) async {
    ...
    await mockNetworkImagesFor(() async {
      await tester.pumpWidget(
        MaterialApp(
          ...
          home: Scaffold(
            body: VehiclesDropDownList( // هنا كان الخطأ، قمنا باستدعاء الكلاس مباشرة
              vehicles: tVehicles,
